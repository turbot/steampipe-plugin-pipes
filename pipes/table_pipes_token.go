...
func tablePipesToken(_ context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "pipes_token",
		Description: "Tokens can be used to access the Turbot Pipes API or to connect to Turbot Pipes workspaces from the Steampipe CLI.",
